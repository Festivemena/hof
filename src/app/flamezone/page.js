    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-900">
        ...
        >
          ...
          {isLoading ? ( // Show loading spinner when processing
            <div className="flex justify-center items-center h-32">
              <div className="loader border-t-transparent border-4 border-white border-solid rounded-full w-16 h-16 animate-spin"></div>
            </div>
          ) : (
